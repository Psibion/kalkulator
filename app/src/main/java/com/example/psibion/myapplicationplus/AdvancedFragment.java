...
public class AdvancedFragment extends Fragment implements View.OnClickListener {
    ...
    Button btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btn0, btnBksp, btnC, btnPlusMinus, btnEquals, btnDiv,
            btnMultiply, btnDot, btnPlus, btnMinus, btnSin, btnCos,btnTan, btnLn, btnSqrt, btnXY, btnLog, btnPotega;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.advanced_fragment, container, false);
        ...
        btnSqrt = (Button) rootView.findViewById(R.id.btnSqrt);
        btnXY = (Button) rootView.findViewById(R.id.btnXY);
        btnLog= (Button) rootView.findViewById(R.id.btnLog);
        btnPotega = (Button) rootView.findViewById(R.id.btnPotega);
        ...
        btnPotega.setOnClickListener(this);
    ...
    public void operation()
    {
        ...
        if (operation.equals("+")) {
            ...
            if(display.getText().toString().substring(1).equals("0")){
                ...
                Toast t =  Toast.makeText(context, "Błąd!", Toast.LENGTH_LONG);
                t.show();
            }
        }
